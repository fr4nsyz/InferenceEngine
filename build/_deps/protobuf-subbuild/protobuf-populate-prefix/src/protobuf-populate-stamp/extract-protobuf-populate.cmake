...
#
get_filename_component(filename "/home/fr4nsyz/vault/L_CACHES/InferenceEngine/build/_deps/protobuf-subbuild/protobuf-populate-prefix/src/protobuf-28.3.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/fr4nsyz/vault/L_CACHES/InferenceEngine/build/_deps/protobuf-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-protobuf-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-protobuf-populate${i}")
